...
class Validation
{
  ...
  // crea validacion para que el rol
  'tipo_rol' => [
    'label' => 'Rol',
    'rules' => 'required|is_unique[roles.tipo_rol]|min_length[3]|max_length[20]|trim|alpha',
    'errors' => [
      ...
      'alpha' => 'El rol solo puede contener letras sin espacios',
    ],
  ],
];
